...
/**
 * Lambang WhatsApp yang sebenarnya.
 *
 * Satu-satunya ikon di berkas ini yang tidak berasal dari lucide, dan satu-satunya
 * yang digambar dengan isian penuh alih-alih garis. Sengaja: yang dicari petugas
 * di layar bukan "gelembung obrolan" melainkan lambang WhatsApp yang ia kenali
 * seketika, dan lambang itu memang tidak ada bentuk garisnya. Pustaka lucide sudah
 * membuang seluruh ikon merek, jadi jalurnya ditulis langsung di sini.
 *
 * Karena berisian penuh, ia mengabaikan strokeWidth — sifatnya berbeda dari ikon
 * lain di berkas ini, dan itu disengaja.
 */
export function IkonWhatsApp({ className }: { className?: string }) {
  return (
